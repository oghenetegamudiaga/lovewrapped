...
const seedDemoWedding: Wedding = {
  ...
  template: {
    ...
    text_fields: [
      ...
      { field_key: 'family_line', label: 'Family Line', static_text: 'TOGETHER WITH THEIR FAMILIES', x: 10, y: 18, width: 80, max_font_size: 12, min_font_size: 10, color: '#4A2E35', align: 'center', font_family: 'sans' },
      { field_key: 'couple_names', label: 'Couple Names', x: 10, y: 26, width: 80, max_font_size: 34, min_font_size: 22, color: '#3A0D22', align: 'center', font_family: 'serif' },
      { field_key: 'invitee_prefix', label: 'Invitee Prefix', static_text: 'REQUEST THE PRESENCE OF', x: 10, y: 49, width: 80, max_font_size: 11, min_font_size: 9, color: '#4A2E35', align: 'center', font_family: 'sans' },
      { field_key: 'invitee_name', label: 'Invitee Guest Name', x: 15, y: 55, width: 70, max_font_size: 20, min_font_size: 14, color: '#3A0D22', align: 'center', font_family: 'serif' },
      { field_key: 'monogram_seal', label: 'Monogram Seal', x: 40, y: 65, width: 20, max_font_size: 16, min_font_size: 12, color: '#3A0D22', align: 'center', font_family: 'serif' },
      { field_key: 'marriage_date_line', label: 'Marriage Date Line', static_text: 'ARE GETTING MARRIED ON', x: 10, y: 74, width: 80, max_font_size: 13, min_font_size: 10, color: '#3A0D22', align: 'center', font_family: 'sans' },
      { field_key: 'venue', label: 'Venue & Location', x: 10, y: 84, width: 80, max_font_size: 13, min_font_size: 11, color: '#4A2E35', align: 'center', font_family: 'sans' },
    ],
  },
  created_at: new Date(Date.now() - 86400000 * 3).toISOString(),
