...
const seedDemoExperience: Experience = {
  ...
  image_count: 3,
  is_paid: true,
  music_track: 'iyawo-mi',
  music_source_type: 'curated',
...
const seedDemoWedding: Wedding = {
  ...
  card_template_url: '/demo-wedding/wedding-cover.jpg',
  template: {
    id: 'demo-wedding-template',
    name: 'Classic Luxury Wedding Invitation',
    image_url: '/demo-wedding/wedding-cover.jpg',
    orientation: 'portrait',
    width: 1200,
    height: 1500,
    is_active: true,
    text_fields: [
      { field_key: 'invitation_badge', label: 'Badge / Pill', static_text: 'OFFICIAL INVITATION', x: 10, y: 10, width: 80, max_font_size: 11, min_font_size: 9, color: '#3A0D22', align: 'center', font_family: 'sans' },
      { field_key: 'family_line', label: 'Family Line', static_text: 'TOGETHER WITH THEIR FAMILIES', x: 10, y: 17, width: 80, max_font_size: 12, min_font_size: 10, color: '#4A2E35', align: 'center', font_family: 'sans' },
      { field_key: 'couple_names', label: 'Couple Names', x: 10, y: 24, width: 80, max_font_size: 34, min_font_size: 22, color: '#3A0D22', align: 'center', font_family: 'serif' },
      { field_key: 'invitee_prefix', label: 'Invitee Prefix', static_text: 'REQUEST THE PRESENCE OF', x: 10, y: 47, width: 80, max_font_size: 11, min_font_size: 9, color: '#4A2E35', align: 'center', font_family: 'sans' },
      { field_key: 'invitee_name', label: 'Invitee Guest Name', x: 15, y: 53, width: 70, max_font_size: 20, min_font_size: 14, color: '#3A0D22', align: 'center', font_family: 'serif' },
      { field_key: 'monogram_seal', label: 'Monogram Seal', x: 40, y: 62, width: 20, max_font_size: 16, min_font_size: 12, color: '#3A0D22', align: 'center', font_family: 'serif' },
      { field_key: 'marriage_date_line', label: 'Marriage Date Line', static_text: 'ARE GETTING MARRIED ON', x: 10, y: 71, width: 80, max_font_size: 13, min_font_size: 10, color: '#3A0D22', align: 'center', font_family: 'sans' },
      { field_key: 'venue', label: 'Venue & Location', x: 10, y: 80, width: 80, max_font_size: 13, min_font_size: 11, color: '#4A2E35', align: 'center', font_family: 'sans' },
      { field_key: 'footer_note', label: 'Footer Note', static_text: 'FORMAL INVITATION TO FOLLOW', x: 10, y: 87, width: 80, max_font_size: 11, min_font_size: 9, color: '#4A2E35', align: 'center', font_family: 'sans' },
    ],
  },
  created_at: new Date(Date.now() - 86400000 * 3).toISOString(),
