...
const seedDemoWedding: Wedding = {
  ...
  template: {
    ...
    is_active: true,
    text_fields: [
      { field_key: 'invitation_badge', label: 'Badge / Pill', static_text: 'OFFICIAL INVITATION', x: 10, y: 6, width: 80, max_font_size: 11, min_font_size: 9, color: '#FCD34D', align: 'center', font_family: 'sans' },
      { field_key: 'family_line', label: 'Family Line', static_text: 'TOGETHER WITH THEIR FAMILIES', x: 10, y: 12, width: 80, max_font_size: 12, min_font_size: 10, color: '#FDE68A', align: 'center', font_family: 'sans' },
      { field_key: 'couple_names', label: 'Couple Names', x: 10, y: 20, width: 80, max_font_size: 38, min_font_size: 22, color: '#FFFFFF', align: 'center', font_family: 'serif' },
      { field_key: 'invitee_prefix', label: 'Invitee Prefix', static_text: 'REQUEST THE PRESENCE OF', x: 10, y: 42, width: 80, max_font_size: 11, min_font_size: 9, color: '#FDE68A', align: 'center', font_family: 'sans' },
      { field_key: 'invitee_name', label: 'Invitee Guest Name', x: 15, y: 48, width: 70, max_font_size: 20, min_font_size: 14, color: '#FFFFFF', align: 'center', font_family: 'serif' },
      { field_key: 'monogram_seal', label: 'Monogram Seal', x: 40, y: 57, width: 20, max_font_size: 16, min_font_size: 12, color: '#FCD34D', align: 'center', font_family: 'serif' },
      { field_key: 'marriage_date_line', label: 'Marriage Date Line', static_text: 'ARE GETTING MARRIED ON', x: 10, y: 67, width: 80, max_font_size: 14, min_font_size: 11, color: '#FFFFFF', align: 'center', font_family: 'sans' },
      { field_key: 'venue', label: 'Venue & Location', x: 10, y: 78, width: 80, max_font_size: 13, min_font_size: 11, color: '#FDE68A', align: 'center', font_family: 'sans' },
      { field_key: 'footer_note', label: 'Footer Note', static_text: 'FORMAL INVITATION TO FOLLOW', x: 10, y: 88, width: 80, max_font_size: 11, min_font_size: 9, color: '#FDE68A', align: 'center', font_family: 'sans' },
    ],
  },
  created_at: new Date(Date.now() - 86400000 * 3).toISOString(),
