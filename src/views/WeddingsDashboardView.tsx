                      ...
                      filteredGuests.map((g) => {
                        ...
                        return (
                          <tr key={g.id} className="hover:bg-cream/40 transition-colors">
                            ...
                            <td className="py-4 px-6">
                              {g.opened_at ? (
                                <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-emerald-100 text-emerald-800 text-[10px] font-semibold border border-emerald-200">
                                  <Eye className="w-3 h-3 text-emerald-600" /> Viewed {new Date(g.opened_at).toLocaleDateString()}
                                </span>
                              ) : (
                                <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-amber-50 text-amber-700 text-[10px] font-semibold border border-amber-200">
                                  Not Opened
                                </span>
                              )}
                            </td>
